...
public class ProjectApplicationController {
    ...
    @GetMapping("/{post_id}/applicants/{uuid}")
    public CommonResponse<ShowProjectApplicantInfoResponseVo> ShowProjectApplicantsInfo(@PathVariable("post_id") Long postId, @PathVariable("uuid") UUID uuid) {
        try {
            ShowProjectApplicantInfoResponseDto showProjectApplicantInfoResponseDto = projectApplicationService.getApplicantInfo(postId, uuid);
    ...
    @PatchMapping("/{post_id}/applicants/{uuid}")
    public CommonResponse<ChangeApplyStatusResponseVo> ChangeApplyStatus(
        ...
        try {
            ChangeApplyStatusResponseDto changeApplyStatusResponseDto = projectApplicationService.changeApplyStatus(postId,uuid,changeApplyStatusRequestDto.getStatus());
    ...
    public CommonResponse<ShowApplyingProjectListResponseVo> ShowApplyingProjectList(
        ...
        @RequestParam(value = "limit", defaultValue = "10") int limit) {
        try {
            ShowApplyingProjectInfoResponseDto showApplyingProjectInfoResponseDto = projectApplicationService.getApplyingProjectInfo(page, limit);
